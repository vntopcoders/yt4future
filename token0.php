...
if ($client->getAccessToken()) {
  try {
    ...
    foreach ($broadcastsResponse['items'] as $broadcastItem) {
      $broadcastItem["status"]->setPrivacyStatus('private');
      print_r($broadcastItem["status"]);
      ...
      $htmlBody .= sprintf('<li>%s (%s) (%s)</li>', $broadcastItem['snippet']['title'],
          $broadcastItem['id'], $broadcastItem['status']->getPrivacyStatus()) ;
    }
    $htmlBody .= '</ul>';
